...
import (
	...
	mockdb "github.com/keshavbhattad/bank/db/mock"
	...
	testCases := []struct {
	...
	}{
		{
			...
			checkResponse: func(recorder *httptest.ResponseRecorder) {
				...
				requireUserBodyMatching(t, recorder.Body, user)
			},
		},
		{
...
func requireUserBodyMatching(t *testing.T, body *bytes.Buffer, user db.User) {
